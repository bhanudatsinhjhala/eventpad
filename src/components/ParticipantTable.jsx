...
function sortAttendance(array, order) {
    ...
    array.sort(function (a, b) {
        var nameA = a.present.toLowerCase(), nameB = b.present.toLowerCase();
        if (order !== "desc") {
            ...
            <Paper sx={{ width: '100%', my: 1, mb: 2 }}>
                <TableContainer>
                    ...
                    >
                        ...
                        />
                        <TableBody>
                            {stableSort(props.rows, getComparator(order, orderBy), orderBy, order)
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="left" sx={{ textTransform: "uppercase", color: row.present === "true" ? "#02e076" : "#ffaa8c" }}>{row.present}</TableCell>
                                        </TableRow>
                                    );
                                })}
                        </TableBody>
